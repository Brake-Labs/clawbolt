...
export function summary(overrides: Partial<EvalSummary> = {}): EvalSummary {
  return {
    ...
    blocking_findings: 0,
    judge_counts: {},
    judge_skip_counts: { identical: 40 },
    identical_rate: 1,
    divergence_rate: 0,
    silent_noop_rate: 0,
    ...
    baseline: {
      ...
      cache_participation_ratio: 0.9,
      total_cost_usd: '1.500000',
      pricing_available: true,
      pricing_unknown_reason: '',
      latency_p50_ms: 1200,
      latency_p95_ms: 2400,
    },
    candidate: {
...
export function run(overrides: Partial<EvalRun> = {}): EvalRun {
  return {
    ...
    baseline_turns_unavailable: 0,
    historic_other_config_calls: 0,
